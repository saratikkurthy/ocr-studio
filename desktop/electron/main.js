...
import { registerGovernanceIpc } from "./governanceService.js";
import { registerKnowledgeGraphIpc } from "./knowledgeGraphService.js";
import { registerTimelineNarrativeIpc } from "./timelineNarrativeService.js";
import { registerCrossProjectGraphIpc } from "./crossProjectGraphService.js";
import { registerResearchWorkbenchIpc } from "./researchWorkbenchService.js";
import { registerCitationIpc } from "./citationService.js";
import { registerResearchCanvasIpc } from "./researchCanvasService.js";
import { registerEvidenceResearchAssistantIpc } from "./evidenceResearchAssistantService.js";
import { registerCorpusIntelligenceIpc } from "./corpusIntelligenceService.js";
import { registerResearchDiscoveryIpc } from "./researchDiscoveryService.js";
import { registerEditionManagerIpc } from "./editionManagerService.js";
import { registerCriticalTextIpc } from "./criticalTextService.js";
import { registerEditorialDecisionIpc } from "./editorialDecisionService.js";
import { registerEditorialAiIpc } from "./editorialAiService.js";
import { registerPublicationValidatorIpc } from "./publicationValidatorService.js";
import { registerPublicationExporterIpc } from "./publicationExporterService.js";
import { registerScholarlyLibraryIpc } from "./scholarlyLibraryService.js";
import { registerEditionComparisonIpc } from "./editionComparisonService.js";
import { registerManuscriptCollationIpc } from "./manuscriptCollationService.js";
import { registerStemmaAnalysisIpc } from "./stemmaAnalysisService.js";
import { registerCriticalApparatusIpc } from "./criticalApparatusService.js";
import { registerParallelCorpusIpc } from "./parallelCorpusService.js";
import { registerEntityIntelligenceIpc } from "./entityIntelligenceService.js";
import { registerScholarlyAssistantIpc } from "./scholarlyAssistantService.js";
import { registerIiifManuscriptIpc } from "./iiifManuscriptService.js";
import { registerCollaborationIpc } from "./collaborationService.js";
import { registerInstitutionalRepositoryIpc } from "./institutionalRepositoryService.js";
import { registerPublicScholarlyPortalIpc } from "./publicScholarlyPortalService.js";
...
registerGovernanceIpc(ipcMain, dialog, shell, readRecentProjects);
registerKnowledgeGraphIpc(ipcMain, dialog, shell, readRecentProjects);
registerEntityIntelligenceIpc({ ipcMain, shell, getProjects: readRecentProjects });
registerScholarlyAssistantIpc({ ipcMain, shell, getProjects: readRecentProjects });
registerIiifManuscriptIpc({ ipcMain, shell, getProjects: readRecentProjects });
registerCollaborationIpc({ ipcMain, shell, getProjects: readRecentProjects });
registerInstitutionalRepositoryIpc({ ipcMain, shell, getProjects: readRecentProjects });
registerPublicScholarlyPortalIpc({ ipcMain, shell, getProjects: readRecentProjects });
registerTimelineNarrativeIpc({ ipcMain, dialog, shell, getProjects: readRecentProjects });
registerCrossProjectGraphIpc({ ipcMain, dialog, shell, getProjects: readRecentProjects });
registerResearchWorkbenchIpc({ ipcMain, dialog, shell });
registerCitationIpc({ ipcMain, dialog, shell });
registerResearchCanvasIpc({ ipcMain, dialog, shell });
registerEvidenceResearchAssistantIpc({ ipcMain, shell });
registerCorpusIntelligenceIpc({ ipcMain, shell });
registerResearchDiscoveryIpc({ ipcMain, shell });
registerEditionManagerIpc({ ipcMain, shell });
registerCriticalTextIpc({ ipcMain });
registerEditorialDecisionIpc({ ipcMain });
registerEditorialAiIpc({ ipcMain });
registerPublicationValidatorIpc({ ipcMain, shell });
registerPublicationExporterIpc({ ipcMain, shell });
registerScholarlyLibraryIpc({ ipcMain, shell });
registerEditionComparisonIpc({ ipcMain, shell });
registerManuscriptCollationIpc({ ipcMain, shell });
registerStemmaAnalysisIpc({ ipcMain, shell });
registerCriticalApparatusIpc({ ipcMain, shell });
registerParallelCorpusIpc({ ipcMain, shell });
